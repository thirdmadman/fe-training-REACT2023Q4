interface IItemsPerPageSelect {
  currentItemsPerPage: number;
  onNewValueSelect: (value: number) => void;
}

export function ItemsPerPageSelect(props: IItemsPerPageSelect) {
  const { currentItemsPerPage, onNewValueSelect } = props;
  ...
  return (
    <div className="flex">
      ...
      <select
        ...
        onInput={(e) => onNewValueSelect(Number(e.currentTarget.value))}
